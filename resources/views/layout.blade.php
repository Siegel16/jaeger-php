...
<head>
    ...
    <script>
        ;(function(d, s, c) {
            ...
            j.src = 'https://unpkg.com/@elastic/apm-rum@4.5.1/dist/bundles/elastic-apm-opentracing.umd.min.js'
            j.onload = function() {elasticApm.init(c)}
            t.parentNode.insertBefore(j, t)
        })(document, 'script', {serviceName: 'php-rum', breakdownMetrics: true, pageLoadTransactionName: window.location.href})
    </script>
</head>
<body>
